...
assert EntrepotExist {some r:Receptacle | one e:Entrepot | !ObjetSurCoord [r,e]}
...
assert CoordonneesPlusieursReceptacles {no c: Coordonnees | one r1: Receptacle | one r2: Receptacle | ObjetSurCoord [r1,c] && ObjetSurCoord[r2,c] && r1 != r2}
--check CoordonneesPlusieursReceptacles for 5 but 5 Int
...
--check ReceptacleNonOrigine for 5 but 5 Int
...
--check IndexEntrepotChemin for 5 but 5 Int
